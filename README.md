...
Driven by curiosity and a hands-on mindset, I enjoy working with real systems — from PLC-controlled stations to workflow and test automation — and learning how complex systems behave under real constraints.

🎓 Learning through:
- Academic automation projects  
- Hands-on control and testing tasks  
- Practical internships and experimentation  

🚀 I see automation not only as programming, but as a way to structure, verify, and improve system behavior.
...
- Linux  
- LaTeX  
- Basic simulation and testing mindset  
